...
public class ObjectUtils {
    ...
    public static boolean isAllEmpty(Object... stringList)  {
        //有一个不为空，则就不是全部为空
        return Arrays.stream(stringList).noneMatch(org.apache.commons.lang3.ObjectUtils::isNotEmpty);
    }
    ...
    public static boolean isNotEmpty(Object... stringList) {
        //没有为空的就是都不为空
        return Arrays.stream(stringList).noneMatch(org.apache.commons.lang3.ObjectUtils::isEmpty);
    }
}
