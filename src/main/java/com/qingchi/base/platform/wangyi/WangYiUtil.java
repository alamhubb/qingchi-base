...
import com.qingchi.base.model.report.AntispamDO;
import com.qingchi.base.repository.plugins.AntispamRepository;
...
public class WangYiUtil {
    ...
    public void setRestTemplate(RestTemplate restTemplate) {
        WangYiUtil.restTemplate = restTemplate;
    }
    ...
    public static AntispamDO checkWYContentSecPost(BaseModelDO baseModelDO) throws IOException {
        ...
        antispamDO.setContentId(baseModelDO.getDbId());
    ...
    public static WyCommonResultVO checkContentWYSecPostBase(String content) throws IOException {
        ...
        // 2.设置私有参数
        params.put("dataId", TokenUtils.getUUID());
