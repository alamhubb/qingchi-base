...
import static com.qingchi.base.constant.CommonConst.hour;
import static com.qingchi.base.constant.CommonConst.minute;
...
public class MatchConstants {
    ...
    //俩人多长时间不说话，解除惩罚双方
    public static final Integer MINUTE_5 = 5 * minute;
    public static final Integer MINUTE_15 = 15 * minute;
    public static final Integer MINUTE_30 = 30 * minute;
    public static final Integer HOUR_2 = 2 * hour;
}
